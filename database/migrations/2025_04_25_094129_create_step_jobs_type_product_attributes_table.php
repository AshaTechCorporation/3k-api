...
class CreateStepJobsTypeProductAttributesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('step_jobs_type_product_attributes', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('step_jobs_type_product_attributes');
    }
}

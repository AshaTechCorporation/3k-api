...
class InsuranceController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $check = Insurance::where('phone', $request->phone)->first();
        if ($check) {
        ...
        try {
            $prefix = "#INS-";
            $id = IdGenerator::generate(['table' => 'insurances', 'field' => 'code', 'length' => 9, 'prefix' => $prefix]);
            ...
            if ($request->image && $request->image != null && $request->image != 'null') {
                $Item->image = $this->uploadImage($request->image, '/images/insurances/');
            }

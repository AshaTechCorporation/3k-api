...
class ProvinceController extends Controller
{
    ...
    public function getPage(Request $request)
    {
        ...
        $col = array('id', 'khet_id', 'code', 'name', 'create_by', 'update_by', 'created_at', 'updated_at');

        $orderby = array('', 'khet_id', 'code', 'name', 'create_by');

        $D = Province::select($col);

...
class BrandModelController extends Controller
{
    ...
    {
        $Item = BrandModel::where('brand_id',$id)->get();
    ...
    public function getPage(Request $request)
    {
        ...
        $col = array('id', 'name', 'brand_id', 'detail', 'create_by', 'update_by', 'created_at', 'updated_at');

        $orderby = array('', 'name', 'brand_id', 'detail', 'create_by');

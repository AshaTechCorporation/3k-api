...
class GarageController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $check = Garage::where('phone', $request->phone)->first();
        if ($check) {
        ...
        try {
            $prefix = "#GA-";
            $id = IdGenerator::generate(['table' => 'garages', 'field' => 'code', 'length' => 9, 'prefix' => $prefix]);
            ...
            if ($request->image && $request->image != null && $request->image != 'null') {
                $Item->image = $this->uploadImage($request->image, '/images/garages/');
            }
